    ...
    <>
      <div>
        <input
          ...
          className="border mr-2 p-1 min-w-56"
          onChange={(e) => {
            setInput(e.target.value);
          }}
        />
        <button className="btn" onClick={getProfileInfo}>
      ...
      {isLoading && (
        <h1 className="mt-10 text-3xl text-slate-800 font-bold">Loading...</h1>
      )}

      {githubUser && (
        <div className="text-gray-300 rounded-lg text-sm w-[350px] bg-[#161b22] border border-[#3f3f46] mx-auto mt-10">
          <div className="w-full flex flex-row space-x-3 p-4">
            ...
            <div className="w-full text-gray-500">
              <p className="w-[200px] text-lg space-x-1 inline-block overflow-hidden whitespace-nowrap text-ellipsis">
                <span className="text-gray-100">{githubUser.login}</span>
                <span className="font-extralight"></span>
              </p>
              <p className="text-start">
                {githubUser.bio || <span className="text-slate-400">null</span>}
              </p>
            </div>
          </div>
          ...
          <div className="w-full flex-col space-y-1 p-4 text-gray-500 text-sm">
            ...
            >
              ...
              <a className="text-gray-100 hover:text-blue-500" href="#">
                @
